...
CLARITY_JS='<script type="text/javascript" crossorigin="anonymous">(function(c,l,a,r,i,t,y){c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};t=l.createElement(r);t.async=1;t.setAttribute("crossorigin","anonymous");t.src="https://www.clarity.ms/tag/"+i;y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);c[a]("start",i);})(window, document, "clarity", "script", "'"$CLARITY_ID"'");</script>'
